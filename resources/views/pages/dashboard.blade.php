                ...
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center gap-2">
                            <div class="social-icons"><img src="{{asset('/ui')}}/assets/images/dashboard/social/1.png"
                                        ...
                                        <g id="SvgjsG2337" class="apexcharts-inner apexcharts-graphical"
                                            ...
                                            <defs id="SvgjsDefs2336">
                                                <clipPath id="gridRectMaskmn2r6amt">
                                                    <rect id="SvgjsRect2339" width="112" height="130" x="-3" y="-1"
                                                ...
                                                <clipPath id="gridRectMarkerMaskmn2r6amt">
                                                    <rect id="SvgjsRect2340" width="110" height="132" x="-2" y="-2"
                                                        rx="0" ry="0" opacity="1" stroke-width="0" stroke="none"
                                                        stroke-dasharray="0" fill="#fff"></rect>
                                                </clipPath>
                                                <filter id="SvgjsFilter2353" filterUnits="userSpaceOnUse" width="200%"
                                                    ...
                                                    <feComposite id="SvgjsFeComposite2355" in="SvgjsFeFlood2354Out"
                                                        ...
                                                        result="SvgjsFeComposite2355Out"></feComposite>
                                            ...
                                            <g id="SvgjsG2341" class="apexcharts-radialbar">
                                                <g id="SvgjsG2342">
                                                    <g id="SvgjsG2343" class="apexcharts-tracks">
                                                        <g id="SvgjsG2344"
                                                            ...
                                                            <path id="apexcharts-radialbarTrack-0"
                                                                ...
                                                                stroke-linecap="round" stroke-width="1.7648780487804883"
                                                    ...
                                                    <g id="SvgjsG2346">
                                                        ...
                                                        <circle id="SvgjsCircle2347" r="24.41268292682927" cx="53"
                                                            cy="53" class="apexcharts-radialbar-hollow"
        ...
        <div class="col-xl-3 col-sm-6">
            <div class="card social-widget">
                <div class="card-body">
                    ...
                    <div class="social-content">
                        <div>
                            <h5 class="mb-1">{{@$data['data']['total']['failedCount']}}</h5><span class="f-light">Failed
                                Count</span>
                        </div>
                        <div class="social-chart">
                            <div id="radial-facebook" style="min-height: 96.4px;">
                                                    ...
                                                    <defs id="SvgjsDefs2336">
                                                        ...
                                                        <filter id="SvgjsFilter2353" filterUnits="userSpaceOnUse"
                                                            ...
                                                            <feComposite id="SvgjsFeComposite2355"
                                                                in="SvgjsFeFlood2354Out" in2="SourceAlpha" operator="in"
                                                                result="SvgjsFeComposite2355Out">
                                                            </feComposite>
                                                            <feOffset id="SvgjsFeOffset2356" dx="0" dy="3"
                                                        ...
                                                        <g id="SvgjsG2342">
                                                            ...
                                                            <g id="SvgjsG2346">
                                                                ...
                                                                <g id="SvgjsG2348" class="apexcharts-datalabels-group"
                                                                    ...
                                                                    style="opacity: 1;"><text id="SvgjsText2349"
    ...
    <div class="card">
        ...
        <div class="card-body pt-0 assignments-table px-0">
            <div class="table-responsive theme-scrollbar">
                <table class="table display p-4" id="assignments-table" style="width:100%;padding: 20px !important;">
                    <thead>
                        <tr>
