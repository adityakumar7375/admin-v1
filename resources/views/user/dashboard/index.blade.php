                         ...
                         <div class="d-flex align-items-center justify-content-between">
                             <div class="d-flex align-items-center gap-2">
                                 <div class="social-icons"><img
                                         src="{{Cache::get('baseUrl')}}/assets/image/{{$row['total_icon']}}" height="50"
                                         alt="icon">
                                 </div>
                                 <span class="f-w-600">{{$row['total_title_1']}}</span>
                             </div>
                             <span
                                 class="font-success f-12 d-xxl-block d-xl-none">{{$row['total_transaction_count']}}</span>
                         </div>
                                                         ...
                                                         <g id="SvgjsG2346">
                                                             ...
                                                             <g id="SvgjsG2348" class="apexcharts-datalabels-group"
                                                                 ...
                                                                 <text id="SvgjsText2349"
                                                                     font-family="Helvetica, Arial, sans-serif" x="53"
                                                                     y="53" text-anchor="middle"
