 ...
 <div class="row">
     <div class="col-xl-7 b-center bg-size"
         ...
         <img class="bg-img-cover bg-center" src="{{url('/ui/')}}/assets/images/login/2.jpg" alt="looginpage"
             style="display: none;">
     </div>
         ...
         <div class="login-card login-dark">
             <div>
                 <div><a class="logo text-start" href="index.html"><img class="img-fluid for-light"
                             src="{{@$webData['data']['logoImage']}}" alt="looginpage"><img class="img-fluid for-dark"
                             src="{{@$webData['data']['logoImage']}}" alt="looginpage"></a></div>
